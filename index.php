  ...
  <body>
    ...
    <header>
      ...
      <div style="height: 600px; display: flex; align-items: center;">
        ...
        <div style="height: 400px; width: 800px; display: flex; margin-left:300px; border: 1px solid black; border-radius:75px">
          ...
          <div style="width: 200px; float:left; margin:10px">
            ...
            <center><p>Lucas Christoffers</p></center>
          </div>
          <!-- Container für Angebots Details -->
          <div style="580px">
            <h1 style="text-align: center; width:100%"> zu Verschenken </h1>
            <p style="text-align: left; width: 100%">Hey dies ist ein einfach demonstrationstext und hat keinerlei bedeutung</p>
          </div>
        </div>
      </div>
          ...
          <tr>
            ...
            <th>
              <div style="width: 175px; height: 175px; margin: 20px; border: 2px solid black">
                ...
                <!-- kurzbeschreibung -->
                <div style="width: 171px; height: 121px; text-align:left; margin: 2px"> Hey, dies ist ein einfacher beispiel text </div>
                <!-- Ersteller -->
