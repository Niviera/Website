...
<body>
    ...
    ?>
    <!-- Content -->
    <div id="angeboteins" label="angeboteins">
        <div style="height: 500px; border: 2px solid Black">
            ...
            <!-- Beschreibung -->
            <p>
                Hey dies ist mal wieder ein einfach quatsch text der ausgedacht worden ist. Denn damit soll einfach
                getestet
                werden
                wie der Text tatsächlich aussieht und wie man damit herumspielen kann. Besonders wichtig ist es sobald
                er
                mal ein klein
                wenig länger aussfällt. Aber irgendwie wird es immer schwerer sich quatsch auszudenken... vieleicht
                hätte
                ich einfach
