<?php
    ...
    if(!file_exists($dbName)){
        ...
        INSERT INTO `Nutzer`(`ID`, `EMail`, `Vorname`, `Nachname`, `Addresse`, `PLZ`, `telnr`, `bild`, `passwort`) VALUES ('1','lucaschristoffers1@gmail.com','Lucas','Christoffers','Igelstraße 9a','26655','12414124','Lucas.jpeg','$2y$10$Q9/KPKd.489SWlyRxE9OxurXrdfOqcXdi9TVIra4AfMfR6h7vE/Na');
        INSERT INTO `Nutzer`(`ID`, `EMail`, `Vorname`, `Nachname`, `Addresse`, `PLZ`, `telnr`, `bild`, `passwort`) VALUES ('2','fritz@gmail.com','Fritz','Walter','Bsp 9a','26121','12414124','standart.jpeg','$2y$10$C6/RwAF58FnhnAtjB/bxc.BHQONeRBy.qv2H96FotrN2DOhRy2MaG');
