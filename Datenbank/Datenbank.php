...
class Datenbank{
    private $dbName;
    public function Datenbank($dbPfad){
        $this->dbName = $dbPfad."Nachbarschaftshilfe.db";
    }
    public function erstelleDatenbank(){
        $verbindung = new PDO("sqlite:$this->dbName");
    ...
    public function erstelleVerbindung(){
        ...
        try{
            ...
            /* TODO: Erstelle eine fehlermeldung für keine Verbindung! */
        }
